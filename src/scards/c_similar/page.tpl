    ...
    <script>
        ...
        A.init(function (require) {
            ...
            *%}
            ...
            require(["common/widget/waterfall"],function(waterfall){var wf=new waterfall;wf.init({idName:"waterfall",ajaxUrl:"{%$tplData.ajaxUrl%}",maxPages:masPages,containerId:"viewport"}),wf.getImages()});
        });
    </script>
{%/strip%}{%/block%}
