...
{%block name="content"%}{%strip%}
    <style>
        .result-c-feedback .c-feedback-a{display:block;width:100%;height:45px;line-height:45px;background-image:linear-gradient(to bottom, #f0f0f0, #e5e5e5);background-repeat:repeat;color:#4c4c4c;text-decoration:none;border:1px solid #ccc;text-align:center}.result-c-feedback .c-feedback-a:hover{color:#4c4c4c;text-decoration:none}.result-c-feedback .c-feedback-ico{background-image:url(feedback.png?__inline);background-size:18px 17px;background-repeat:no-repeat;background-position:0 50%;padding-left:28px;font-size:15px}
    </style>
    <div class="{%$cardName%}">
