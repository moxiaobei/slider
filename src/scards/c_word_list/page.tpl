...
{%block name="content"%}{%strip%}
    <style>
        .result-c-word-list .c-word-list-item{padding:10px 0;border-top:1px solid #f5f5f5}.result-c-word-list .c-word-list-item:first-child{border-top:none}.result-c-word-list .c-word-list-box{width:22%;position:relative;padding-bottom:22%}.result-c-word-list .c-word-list-char{border:1px solid #92b9f8;background:#e8f4ff}.result-c-word-list .c-word-list-char .center-box{letter-spacing:-5px;font-size:0;height:100%}.result-c-word-list .c-word-list-char .center-box .center-hack{display:inline-block;font-size:0;width:0;height:100%;vertical-align:middle}.result-c-word-list .c-word-list-char .center-box .center-body{letter-spacing:normal;word-spacing:normal;display:inline-block;font-size:12px;vertical-align:middle;padding:0 !important;margin:0 !important;width:100%;white-space:normal;word-wrap:break-word}.result-c-word-list .c-word-list-img{background:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAECAIAAAAmkwkpAAAAGXRFW…FnZVJlYWR5ccllPAAAABRJREFUCNdj+IEEGID4HRhg48ABAK1ALgnwLRxbAAAAAElFTkSuQmCC) repeat}.result-c-word-list .c-word-list-p{position:absolute;left:0;right:0;top:0;bottom:0;background:no-repeat;background-position:center;background-size:cover}.result-c-word-list .c-word-list-el{position:absolute;color:#00c;top:0;left:0;bottom:0;right:0;padding:3px;text-align:center;overflow:hidden;display:block}.result-c-word-list .c-word-list-el .center-box .center-body{font-size:14px}
    </style>
    <div class="{%$cardName%}">
