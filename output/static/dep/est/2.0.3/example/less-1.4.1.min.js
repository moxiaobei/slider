...
(function (e, t) {
    ...
    (function (r) {
        ...
        r.functions = {
            ...
            lookup: function (e) {
                var i = n('path').extname(e), s = r._mime._types[i];
                if (s === t)
                    throw new Error('Optional dependency "mime" is required for ' + i);
                return s;
            },
            charsets: {
                lookup: function (e) {
        ...
        for (var o = 0; o < i.length; o++)
            r.functions[i[o].name] = s(i[o].name, i[o].unit);
        ...
        e.Color = function (e, t) {
            ...
            toCSS: function (e, t) {
                ...
                if (this.alpha < 1)
                    return 'rgba(' + this.rgb.map(function (e) {
                        return Math.round(e);
            ...
            operate: function (t, n, r) {
                ...
                for (var s = 0; s < 3; s++)
                    i[s] = e.operate(t, n, this.rgb[s], r.rgb[s]);
            ...
            toHSV: function () {
                var e = this.rgb[0] / 255, t = this.rgb[1] / 255, n = this.rgb[2] / 255, r = this.alpha, i = Math.max(e, t, n), s = Math.min(e, t, n), o, u, a = i, f = i - s;
                i === 0 ? u = 0 : u = f / i;
                if (i === s)
                    o = 0;
                else {
        ...
        e.Dimension = function (n, r) {
            ...
            toCSS: function (e) {
                ...
                t !== 0 && t < 0.000001 && t > -0.000001 && (n = t.toFixed(20).replace(/0+$/, ''));
                if (e && e.compress) {
                    if (t === 0 && !this.unit.isAngle())
                        return n;
            ...
            operate: function (t, n, r) {
                var i = e.operate(t, n, this.value, r.value), s = this.unit.clone();
                if (n === '+' || n === '-') {
                    if (s.numerator.length === 0 && s.denominator.length === 0)
                        s.numerator = r.unit.numerator.slice(0), s.denominator = r.unit.denominator.slice(0);
                    else if (r.unit.numerator.length != 0 || s.denominator.length != 0) {
                        r = r.convertTo(this.unit.usedUnits());
                        if (t.strictUnits && r.unit.toString() !== s.toString())
                            throw new Error('Incompatible units. Change the units or use the unit function. Bad units: \'' + s.toString() + '\' and \'' + r.unit.toString() + '\'.');
                        i = e.operate(t, n, this.value, r.value);
                    }
                } else
                    n === '*' ? (s.numerator = s.numerator.concat(r.unit.numerator).sort(), s.denominator = s.denominator.concat(r.unit.denominator).sort(), s.cancel()) : n === '/' && (s.numerator = s.numerator.concat(r.unit.denominator).sort(), s.denominator = s.denominator.concat(r.unit.numerator).sort(), s.cancel());
                return new e.Dimension(i, s);
            },
            compare: function (t) {
                if (t instanceof e.Dimension) {
                    var n = this.unify(), r = t.unify(), i = n.value, s = r.value;
            ...
            convertTo: function (t) {
                var n = this.value, r = this.unit.clone(), i, s, o, u, a, f = {};
                if (typeof t == 'string') {
                    for (i in e.UnitConversions)
                        e.UnitConversions[i].hasOwnProperty(t) && (f = {}, f[i] = t);
                    t = f;
                }
                for (s in t)
                    t.hasOwnProperty(s) && (a = t[s], o = e.UnitConversions[s], r.map(function (e, t) {
            ...
            usedUnits: function () {
                var t, n, r = {};
                for (n in e.UnitConversions)
                    e.UnitConversions.hasOwnProperty(n) && (t = e.UnitConversions[n], this.map(function (e) {
            ...
            cancel: function () {
                var e = {}, t, n, r;
                for (n = 0; n < this.numerator.length; n++)
                    t = this.numerator[n], r || (r = t), e[t] = (e[t] || 0) + 1;
                for (n = 0; n < this.denominator.length; n++)
                    t = this.denominator[n], r || (r = t), e[t] = (e[t] || 0) - 1;
                ...
                for (t in e)
                    if (e.hasOwnProperty(t)) {
                        ...
                        if (i > 0)
                            for (n = 0; n < i; n++)
                                this.numerator.push(t);
                        else if (i < 0)
                            for (n = 0; n < -i; n++)
                                this.denominator.push(t);
                    }
        ...
        e.Expression = function (e) {
            ...
            eval: function (t) {
                var n, r = this.parens && !this.parensInOp, i = !1;
        ...
        e.Extend = function (t, n, r) {
            ...
            findSelfSelectors: function (e) {
                ...
                for (n = 0; n < e.length; n++)
                    t = t.concat(e[n].elements);
                this.selfSelectors = [{ elements: t }];
            }
        };
    }(n('../tree')), function (e) {
        e.Import = function (e, n, r, i, s) {
            ...
            evalPath: function (t) {
                var n = this.path.eval(t), r = this.currentFileInfo && this.currentFileInfo.rootpath;
        ...
        e.mixin = {}, e.mixin.Call = function (t, n, r, i, s) {
            ...
            eval: function (t, n, r) {
                var i = [], s = this.frames.concat(t.frames), o = this.evalParams(t, new e.evalEnv(t, s), n, i), u, a, f, l;
                return o.rules.unshift(new e.Rule('@arguments', new e.Expression(i).eval(t))), a = r ? this.parent.makeImportant.apply(this).rules : this.rules.slice(0), l = new e.Ruleset(null, a).eval(new e.evalEnv(t, [
                    this,
                    o
                ].concat(s))), l.originalRuleset = this, l;
            },
        ...
        e.Negative = function (e) {
            ...
            eval: function (t) {
                return t.isMathOn() ? new e.Operation('*', [
                    new e.Dimension(-1),
                    this.value
                ]).eval(t) : new e.Negative(this.value.eval(t));
            }
        };
    }(n('../tree')), function (e) {
        e.Operation = function (e, t, n) {
            ...
            eval: function (t) {
                ...
                return new e.Operation(this.op, [
                    n,
                    r
                ], this.isSpaced);
            },
        ...
        e.Ruleset = function (e, t, n) {
            ...
            eval: function (t) {
                ...
                for (var s = 0; s < r.rules.length; s++)
                    r.rules[s] instanceof e.mixin.Call && (i = r.rules[s].eval(t).filter(function (t) {
                        return t instanceof e.Rule && t.variable ? !r.variable(t.name) : !0;
                    }), r.rules.splice.apply(r.rules, [
                        s,
                        1
                    ].concat(i)), s += i.length - 1, r.resetCache());
            ...
            evalImports: function (t) {
                ...
                for (n = 0; n < this.rules.length; n++)
                    this.rules[n] instanceof e.Import && (r = this.rules[n].eval(t), typeof r.length == 'number' ? (this.rules.splice.apply(this.rules, [
                        n,
                        1
                    ].concat(r)), n += r.length - 1) : this.rules.splice(n, 1, r), this.resetCache());
            },
            makeImportant: function () {
            ...
            toCSS: function (t) {
                ...
                for (var f = 0; f < this.rules.length; f++) {
                    a = this.rules[f];
                    if (a.rules || a instanceof e.Media)
                        s.push(a.toCSS(t));
                        ...
                        s.push(l);
                    } else if (a instanceof e.Comment)
                        a.silent || (this.root ? s.push(a.toCSS(t)) : r.push(a.toCSS(t)));
                    else if (a.toCSS && !a.variable) {
                        if (this.firstRoot && a instanceof e.Rule)
                            throw {
                ...
                if (this.root)
                    ...
                    for (var f = r.length - 1; f >= 0; f--)
                        (r[f].slice(0, 2) === '/*' || i.indexOf(r[f]) === -1) && i.unshift(r[f]);
                        ...
                        for (s = 0; s < a.length; s++) {
                            ...
                            if (n.length == 0)
                                ...
                                for (o = 0; o < n.length; o++)
                                    c = n[o], h = [], p = [], v = !0, l.length > 0 ? (h = l.slice(0), m = h.pop(), d = new e.Selector(m.elements.slice(0), r.extendList), v = !1) : d = new e.Selector([], r.extendList), c.length > 1 && (p = p.concat(c.slice(1))), c.length > 0 && (v = !1, d.elements.push(new e.Element(f.combinator, c[0].elements[0].value, 0)), d.elements = d.elements.concat(c[0].elements.slice(1))), v || h.push(d), h = h.concat(p), y.push(h);
                        }
                        a = y, g = [];
                    }
                }
            ...
            mergeElementsOnToSelectors: function (t, n) {
                ...
                for (r = 0; r < n.length; r++)
                    i = n[r], i.length > 0 ? i[i.length - 1] = new e.Selector(i[i.length - 1].elements.concat(t), i[i.length - 1].extendList) : i.push(new e.Selector(t));
            }
        };
    }(n('../tree')), function (e) {
        ...
        var r = function (e, t, n) {
            if (!e)
                return;
            for (var r = 0; r < n.length; r++)
                e.hasOwnProperty(n[r]) && (t[n[r]] = e[n[r]]);
        };
    }(n('./tree')), function (e) {
        e.visitor = function (e) {
            ...
            visit: function (e) {
                if (e instanceof Array)
                    return this.visitArray(e);
                if (!e || !e.type)
                    return e;
                var t = 'visit' + e.type, n = this._implementation[t], r, i;
                return n && (r = { visitDeeper: !0 }, i = n.call(this._implementation, e, r), this._implementation.isReplacing && (e = i)), (!r || r.visitDeeper) && e && e.accept && e.accept(this), t += 'Out', this._implementation[t] && this._implementation[t](e), e;
            },
        ...
        e.joinSelectorVisitor = function () {
            ...
            visitRuleset: function (e, t) {
                var n = this.contexts[this.contexts.length - 1], r = [];
        ...
        e.extendFinderVisitor = function () {
            ...
            visitRuleset: function (t, n) {
                ...
                for (r = 0; r < t.rules.length; r++)
                    t.rules[r] instanceof e.Extend && o.push(t.rules[r]);
                for (r = 0; r < t.paths.length; r++) {
                    var a = t.paths[r], f = a[a.length - 1];
                    u = f.extendList.slice(0).concat(o).map(function (e) {
                        return e.clone();
                    });
                    for (i = 0; i < u.length; i++)
                        this.foundExtends = !0, s = u[i], s.findSelfSelectors(a), s.ruleset = t, i === 0 && (s.firstExtendOnThisSelectorPath = !0), this.allExtendsStack[this.allExtendsStack.length - 1].push(s);
                }
            ...
            doExtendChaining: function (t, n, r) {
                var i, s, o, u = [], a, f = this, l, c, h, p;
                r = r || 0;
                for (i = 0; i < t.length; i++)
                    for (s = 0; s < n.length; s++) {
                        c = t[i], h = n[s];
                        if (this.inInheritanceChain(h, c))
                            continue;
                        l = [h.selfSelectors[0]], o = f.findMatch(c, l), o.length && c.selfSelectors.forEach(function (t) {
                            a = f.extendSelector(o, l, t), p = new e.Extend(h.selector, h.option, 0), p.selfSelectors = a, a[a.length - 1].extendList = [p], u.push(p), p.ruleset = h.ruleset, p.parents = [
                                h,
                                c
                            ], h.firstExtendOnThisSelectorPath && (p.firstExtendOnThisSelectorPath = !0, h.ruleset.paths.push(a));
                        });
                    }
                if (u.length) {
            ...
            inInheritanceChain: function (e, t) {
                if (e === t)
                    return !0;
                if (t.parents) {
                    if (this.inInheritanceChain(e, t.parents[0]))
                        return !0;
                    if (this.inInheritanceChain(e, t.parents[1]))
                        return !0;
                }
                return !1;
            },
            ...
            visitRuleset: function (e, t) {
                if (e.root)
                    return;
                var n, r, i, s = this.allExtendsStack[this.allExtendsStack.length - 1], o = [], u = this, a;
                for (i = 0; i < s.length; i++)
                    for (r = 0; r < e.paths.length; r++) {
                        a = e.paths[r];
                        if (a[a.length - 1].extendList.length)
                            continue;
            ...
            findMatch: function (e, t) {
                var n, r, i, s, o, u, a = this, f = e.selector.elements, l = [], c, h = [];
            ...
            isElementValuesEqual: function (t, n) {
                if (typeof t == 'string' || typeof n == 'string')
                    return t === n;
                if (t instanceof e.Attribute)
                    return t.op !== n.op || t.key !== n.key ? !1 : !t.value || !n.value ? t.value || n.value ? !1 : !0 : (t = t.value.value || t.value, n = n.value.value || n.value, t === n);
                return !1;
            },
            extendSelector: function (t, n, r) {
                var i = 0, s = 0, o = [], u, a, f, l;
                for (u = 0; u < t.length; u++)
                    l = t[u], a = n[l.pathIndex], f = new e.Element(l.initialCombinator, r.elements[0].value, r.elements[0].index), l.pathIndex > i && s > 0 && (o[o.length - 1].elements = o[o.length - 1].elements.concat(n[i].elements.slice(s)), s = 0, i++), o = o.concat(n.slice(i, l.pathIndex)), o.push(new e.Selector(a.elements.slice(s, l.index).concat([f]).concat(r.elements.slice(1)))), i = l.endPathIndex, s = l.endPathElementIndex, s >= a.elements.length && (s = 0, i++);
    ...
    r.env = r.env || (location.hostname == '127.0.0.1' || location.hostname == '0.0.0.0' || location.hostname == 'localhost' || location.port.length > 0 || o ? 'development' : 'production'), r.async = r.async || !1, r.fileAsync = r.fileAsync || !1, r.poll = r.poll || (o ? 1000 : 1500);
    if (r.functions)
    ...
    r.modifyVars = function (e) {
        var t = v;
        for (var n in e)
            t += (n.slice(0, 1) === '@' ? '' : '@') + n + ': ' + (e[n].slice(-1) === ';' ? e[n] : e[n] + ';');
