...
(function (e, t) {
    ...
    function k(e, t) {
        ...
        e.stack ? u += '<br/>' + e.stack.split('\n').slice(1).join('<br/>') : e.extract && (c(e, 0, ''), c(e, 1, 'line'), c(e, 2, ''), u += 'on line ' + e.line + ', column ' + (e.column + 1) + ':</p>' + '<ul>' + a.join('') + '</ul>'), s.innerHTML = u, S([
    ...
    typeof environment == 'object' && {}.toString.call(environment) === '[object Environment]' ? (typeof e == 'undefined' ? r = {} : r = e.less = {}, i = r.tree = {}, r.mode = 'rhino') : typeof e == 'undefined' ? (r = exports, i = n('./tree'), r.mode = 'node') : (typeof e.less == 'undefined' && (e.less = {}), r = e.less, i = e.less.tree = {}, r.mode = 'browser'), r.Parser = function (t) {
        ...
        function O(e, t) {
            ...
            this.type = e.type || 'Syntax', this.message = e.message, this.filename = e.filename || t.filename, this.index = e.index, this.line = typeof i == 'number' ? i + 1 : null, this.callLine = e.call && k(e.call, n).line + 1, this.callExtract = o[k(e.call, n).line], this.stack = e.stack, this.column = s, this.extract = [
                o[i - 1],
                o[i],
                o[i + 1]
            ];
            ...
            parsers: {
                ...
                attribute: function () {
                    ...
                    if (t = E(/^(?:[_A-Za-z0-9-]|\\.)+/) || E(this.entities.quoted))
                        (r = E(/^[|~*$^]?=/)) && (n = E(this.entities.quoted) || E(/^[\w-]+/)) ? e = [
                            t,
                            r,
                            n.toCSS ? n.toCSS() : n
                        ].join('') : e = t;
    ...
    (function (e) {
        ...
        e.functions = {
            ...
            luma: function (t) {
                return new e.Dimension(Math.round((0.2126 * (t.rgb[0] / 255) + 0.7152 * (t.rgb[1] / 255) + 0.0722 * (t.rgb[2] / 255)) * t.alpha * 100), '%');
            },
            ...
            mix: function (t, n, r) {
                ...
                var i = r.value / 100, s = i * 2 - 1, o = t.toHSL().a - n.toHSL().a, u = ((s * o == -1 ? s : (s + o) / (1 + s * o)) + 1) / 2, a = 1 - u, f = [
                        t.rgb[0] * u + n.rgb[0] * a,
                        t.rgb[1] * u + n.rgb[1] * a,
                        t.rgb[2] * u + n.rgb[2] * a
            ...
            contrast: function (e, t, n, r) {
                return e.rgb ? (typeof n == 'undefined' && (n = this.rgba(255, 255, 255, 1)), typeof t == 'undefined' && (t = this.rgba(0, 0, 0, 1)), typeof r == 'undefined' ? r = 0.43 : r = r.value, (0.2126 * (e.rgb[0] / 255) + 0.7152 * (e.rgb[1] / 255) + 0.0722 * (e.rgb[2] / 255)) * e.alpha < r ? n : t) : null;
            },
            e: function (t) {
        ...
        e.Ruleset = function (e, t, n) {
            ...
            eval: function (t) {
                ...
                for (var s = 0; s < r.rules.length; s++)
                    r.rules[s] instanceof e.mixin.Call && (i = r.rules[s].eval(t), r.rules.splice.apply(r.rules, [
                        s,
                        1
